...
public class DungeonGenerator extends AbstractMapGenerator {
    ...
    public DungeonGenerator(NpcFactory npcFactory, int averageRoomWidth, int averageRoomHeight, EmptyMapGenerator emptyMapGenerator) {
        super(npcFactory);
